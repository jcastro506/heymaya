...
4. The one question you were given, asked the way you'd ask a friend, with a reason in a few words, as the last text on its own. A lane label in it is said in plain words ("the travel stuff", "the running clips"), never as a category name.
