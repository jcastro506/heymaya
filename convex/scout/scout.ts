...
Say what got you about it as a viewer first, one line, before any number: the moment, named from the evidence you were given, never a timestamp or a detail you were not given. Then why it worked and their version. Send the message the way a person texts: two or three short texts, not one block. Put a line containing only --- between them inside "message"; the link and the buttons ride the last one.
