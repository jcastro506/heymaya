...
export default defineSchema({
  ...
  signals: defineTable({
    ...
    investigation: v.optional(v.array(v.object({ tool: v.string(), params: v.any(), why: v.string(), credits: v.optional(v.number()), ms: v.number(), ok: v.boolean(), detail: v.optional(v.string()), result: v.optional(v.string()) }))),
