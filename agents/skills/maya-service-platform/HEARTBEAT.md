...
- Read the latest `gbpHealthScores` row if today's morning brief hasn't run yet — the score + reasoning are mine from the last audit; I treat them as my own recent thinking, not external data.
- {{plan.proPlusItems}}
