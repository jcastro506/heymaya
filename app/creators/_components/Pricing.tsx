...
const TIERS: Tier[] = [
  ...
  },
  {
    ...
    bullets: [
      ...
      "Cold pitch outreach via Apollo / Hunter",
      "Contract red-flag scan on PDF upload",
      "Quarterly manager-readiness packets",
      "Unlimited chat",
      "Auto-send under thresholds you control",
    ],
    recommended: true,
  },
];
