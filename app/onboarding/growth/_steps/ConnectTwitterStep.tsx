  ...
  return (
    <section>
      ...
      <p className="mb-6 max-w-xl text-paper-dim">
        X charges you per API call (~$0.001 / read, ~$0.01 / write). Riley&rsquo;s
      ...
      <ol className="mb-8 space-y-3 rounded-2xl border border-paper-faint/15 bg-ink-2 p-6 text-sm text-paper-dim">
        <li>
          <span className="text-lime">1.</span> If you don&rsquo;t have one, sign up
          at{" "}
          <a
        ...
        <li>
          <span className="text-lime">2.</span> Open{" "}
          <a
        ...
        <li>
          <span className="text-lime">3.</span> Paste the connectedAccountId
          Composio shows you.
        </li>
      </ol>
