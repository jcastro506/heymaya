...
- **P1 🛠️ Zernio webhooks** — register `post.published/failed/partial` + `comment.received`, build the `/lc_gtm/zernio_webhook` receiver. Replaces 24h re-poll + inbox polling (lower latency + cost). (S2.)
